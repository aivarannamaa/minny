...
class MicroPythonConnection:
        ...
        while len(self._read_buffer) < size:
            ...
            try:
                ...
                if timeout_is_soft:
                    ...
                    raise ReadingTimeoutError(read_bytes=bytes(self._read_buffer)) from e
        ...
        while True:
            ...
            try:
                ...
                if timeout_is_soft:
                    ...
                    raise ReadingTimeoutError(read_bytes=bytes(self._read_buffer))
    ...
    def read_all_expected(self, expected: bytes, timeout: float = 0) -> bytes:
    ...
    def unread(self, data: bytes) -> None:
        ...
        self._read_buffer = bytearray(data) + self._read_buffer
